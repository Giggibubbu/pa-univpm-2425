...
import { userRoleValidation, verifyJwt } from "../middlewares/auth_middlewares.js";
...
import { finalizeDelNavPlanReq, finalizeNavPlanCreateReq, navPlanDelReqValidator, navPlanReqCreationValidator } from "../middlewares/navplan_middlewares.js";
...
userRoleRouter.post('/', navPlanReqCreationValidator, finalizeNavPlanCreateReq, userRoleController.create);
userRoleRouter.delete('/:id', navPlanDelReqValidator, finalizeDelNavPlanReq, userRoleController.delete);
